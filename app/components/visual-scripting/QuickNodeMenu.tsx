...
export default function QuickNodeMenu({
  ...
  return (
    <div
      ...
      className="fixed z-[1000] w-[340px] bg-[#252525] rounded-xl overflow-hidden"
      style={{
        ...menuStyle,
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3.5 bg-[#2a2a2a]">
          ...
          Object.entries(groupedNodes).map(([category, nodes]) => {
            ...
            return (
              <div key={category}>
                {/* Category Header */}
                <div
                  className="px-4 py-2 text-[10px] font-semibold uppercase tracking-wider sticky top-0 bg-[#252525] border-b border-white/[0.03]"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-gray-200 text-[13px] font-medium truncate">
                          {node.label}
                        </div>
                        {node.description && (
      ...
      <div className="px-4 py-2.5 bg-[#1f1f1f]">
        <div className="flex items-center justify-between text-[10px] text-gray-500">
          ...
          <span className="text-gray-600">{flatNodeList.length}</span>
        </div>
      </div>
    </div>
  );
